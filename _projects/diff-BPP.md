...
<div class="row justify-content-sm-center">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/diff-bpp/packing_1.png" title="results" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="caption">
    Placements generated by the Diffusion model base planner for random cuboids on Full sequences as well as subsequence
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/diff-bpp/packing_2.png" title="results" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
